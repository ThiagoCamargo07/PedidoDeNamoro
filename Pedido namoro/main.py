...
def enviar_pedido(resposta):
    if resposta == "Sim":
        messagebox.showinfo("Pedido de Namoro - VPDev", "Eu te amo *nome*!")
        janela.destroy()
        ...
        def txt():
            ...
            pen.down()
            pen.color('white')
            pen.write("Te amo *nome*!", font=("Verdana", 10, "bold"))
...
# Criar rótulo
rotulo = tk.Label(janela, text="*nome*,você aceita namorar comigo?", font=("Arial", 16, "bold"), fg="white", bg=cor_fim)
